...
export const StaticChartComponent = (props: any) => {
  const {
    data,
    colors: {
...
export default function StaticInitComponent(props: any) {
  useEffect(() => {
    document.querySelector("#tv-attr-logo")?.remove();
  }, []);
  return <StaticChartComponent {...props} data={initialData}></StaticChartComponent>;
}
